...
namespace Noppes.E621
{
    ...
    public partial interface IE621Client
    {
        ...
        public Task<ICollection<Post>> GetPostsAsync(int id, Position position, int limit = E621Constants.PostsMaximumLimit, string? tags = null);
        ...
        /// <exception cref="ArgumentException"></exception>
        /// <exception cref="ArgumentOutOfRangeException"></exception>
        public Task<ICollection<Post>> GetPostsAsync(string? tags = null, int? page = null, int limit = E621Constants.PostsMaximumLimit);
